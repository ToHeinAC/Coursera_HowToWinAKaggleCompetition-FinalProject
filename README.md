...
## Results:
- Public leaderboard (LB) score is 0.8886 for _stacktrees\_sub1.csv_ (with a slightly worse private LB score; slightly overfitting?) and 0.9126 for _stacktrees\_sub2.csv_ (with a slightly better private LB score). **This ranks me well into the top 500 of the nearly 9.000 competitors in the public leaderboard atm**.  
